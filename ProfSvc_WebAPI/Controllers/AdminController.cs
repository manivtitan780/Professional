...
public class AdminController : ControllerBase
{
    ...
    /// <param name="entity">
    ///     The entity type. It can be "Title", "Document Type", "User Name", "Education", "Eligibility",
    ...
    /// <summary>
    ///     Toggles the administrative list based on the provided method name, ID, and user name.
    /// </summary>
    /// <param name="methodName">The name of the stored procedure to be executed.</param>
    /// <param name="id">The ID or code to be processed. It can be an integer or a string.</param>
    /// <param name="userName">The user name to be processed.</param>
    ...
    ///     command.
    ///     It also adds a varchar parameter 'User' to the command with the provided user name.
