...
{
	/// <summary>
	///     Initializes a new instance of the <see cref="Requisitions" /> class and resets its properties to their default
	///     values.
	/// </summary>
	public Requisitions()
	{
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="Requisitions" /> class.
	/// </summary>
	...
	public Requisitions(int id, string code, string title, string company, string jobOptions, string status, string updated, string due,
	...
	/// </returns>
	public Requisitions Copy() => MemberwiseClone() as Requisitions;
}