...
public class AppWorkflow
{
	...
	/// </remarks>
	[StringLength(100, MinimumLength = 0, ErrorMessage = "Next Step should not be more than 100 characters.")]
	public string Next
	{
		get;
		set;
	...
	[Required(ErrorMessage = "At least 1 role is required."),
	 StringLength(50, MinimumLength = 1, ErrorMessage = "Role ID's should not be more than 50 characters.")]
	...
	/// </remarks>
	[StringLength(3, MinimumLength = 0, ErrorMessage = "Step should not be more than 3 characters.")]
	public string Step
	{
		get;
		set;
