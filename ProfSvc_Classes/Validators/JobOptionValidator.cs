...
/// </remarks>
public class JobOptionValidator : AbstractValidator<JobOption>
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="JobOptionValidator" /> class.
    /// </summary>
    /// <remarks>
    ///     This constructor sets up the validation rules for the <see cref="JobOption" /> class.
    ///     The rules are defined for each property of the <see cref="JobOption" /> class.
