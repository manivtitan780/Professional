...
public partial class Candidate
{
	...
	private Task AddNewCandidate() => ExecuteMethod(AddChoice.ShowDialog);
		...
		return ExecuteMethod(async () =>
							 {
								 ...
								 Dictionary<string, object> _response = await General.PostRest("Candidates/SaveParsedData", _parameters);
								 int _candidateID = 0;
								 if (_response != null)
								 {
									 SearchModel.Clear();
		...
		return ExecuteMethod(async () =>
							 {
								 ...
								 //Dictionary<string, object> _response = await _client.PostAsync<Dictionary<string, object>>(_request);
								 Dictionary<string, string> _parameters = CreateParameters(id);
								 Dictionary<string, object> _response = await General.PostRest("Candidates/DeleteExperience", _parameters);
								 if (_response == null)
								 {
									 return;
								 }
		...
		return ExecuteMethod(async () =>
							 {
								 ...
								 //Dictionary<string, object> _response = await _client.PostAsync<Dictionary<string, object>>(_request);
								 Dictionary<string, string> _parameters = CreateParameters(id);
								 Dictionary<string, object> _response = await General.PostRest("Candidates/DeleteNotes", _parameters);
								 if (_response == null)
								 {
									 return;
								 }
	...
	/// <returns>A Task that represents the asynchronous operation.</returns>
	private Task ParseCandidate(MouseEventArgs arg) => DialogParseCandidate.ShowDialog();
