...
public partial class CompanyRequisitions
{
    ...
    /// </summary>
    /// <value>
    ///     The list of requisitions of type <see cref="ProfSvc_Classes.Requisitions" />.
    /// </value>
    /// <remarks>
    ...
    /// </remarks>
    [Parameter]
    public List<ProfSvc_Classes.Requisitions> Model
    {
        get;
        set;
    }
    ...
    /// </remarks>
    [Parameter]
    public List<AppWorkflow> Workflows
    {
        get;
        set;
    } = new();
    ...
    /// </remarks>
    private async Task OnActionBegin(ActionEventArgs<ProfSvc_Classes.Requisitions> arg) => await Task.Yield();
    ...
    ///     completed.
    /// </remarks>
    private async Task OnActionComplete(ActionEventArgs<ProfSvc_Classes.Requisitions> arg) => await Task.Yield();
