...
// Last Updated On:     12-6-2023 21:2
// *****************************************/
...
public partial class ViewPDFDocument
{
    ...
    private async Task OpenDialog()
    {
        ...
        string _fileName = Path.Combine(Start.UploadsPath, "Uploads", _entity, EntityID.ToString(), InternalFileName);
        ...
        else
        {
            ...
            //using (WordDocument _doc = new(new MemoryStream(await File.ReadAllBytesAsync(_fileName)), GetWFormatType()))
            //{
