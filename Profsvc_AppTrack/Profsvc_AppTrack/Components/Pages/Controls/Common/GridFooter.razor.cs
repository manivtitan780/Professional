...
// Created On:          12-09-2022 14:45
// Last Updated On:     09-25-2023 21:35
// *****************************************/
...
public partial class GridFooter
{
    ...
    /// This event callback is of type <see cref="EventCallback{String}" />, which means it will provide the key of the clicked status link as event data.
    /// </summary>
    [Parameter]
    ...
    /// If the alphabet button's character matches this property's value, the button will have the "selectedAlphabet" CSS class.
    /// </summary>
    [Parameter]
    public string Name
    {
    ...
    ///     When a status link button is clicked, the <see cref="LinkClicked"/> event callback is triggered with the key of the clicked status link as event data.
    /// </summary>
    [Parameter]
