...
public partial class SubmitCandidate
{
    ...
    /// </remarks>
    private async Task SubmitCandidateToRequisitionDialog(EditContext editContext) => await General.CallSaveMethod(editContext, Spinner, FooterDialog, Dialog, Save);
}