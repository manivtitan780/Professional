...
// Last Updated On:     09-05-2023 19:42
// *****************************************/
...
public partial class EditEducationDialog
{
    ...
    /// </remarks>
    private EditForm EditEducationForm
    {
        get;
        set;
    }
    ...
    {
        EditEducationForm.EditContext?.Validate();
    }
    ...
    /// </remarks>
    private async Task TextOnly(string textBox, bool numbers)
    {
        await JsRuntime.InvokeVoidAsync("onCreate", textBox, numbers);
    }
}