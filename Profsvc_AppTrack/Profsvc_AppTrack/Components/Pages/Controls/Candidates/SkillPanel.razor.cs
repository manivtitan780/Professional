...
public partial class SkillPanel
{
    ...
    /// <summary>
    ///     Gets or sets the event callback that is triggered when an skill entry is to be deleted.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    ///     Gets or sets the event callback that is triggered when an skill entry is to be edited.
    /// </summary>
    /// <value>
