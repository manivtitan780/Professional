...
// Last Updated On:     09-08-2023 15:45
// *****************************************/
...
public partial class NotesPanel
{
    ...
    /// <summary>
    ///     Gets or sets the event callback that is triggered when an note entry is to be deleted.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    ///     Gets or sets the event callback that is triggered when an note entry is to be edited.
    /// </summary>
    /// <value>
    ...
    ///     notes.
    ///     Each row in the grid represents an note entry of the candidate.
