...
// Last Updated On:     09-05-2023 21:25
// *****************************************/
...
public partial class MPCCandidateDialog
{
    ...
    /// <summary>
    ///     Gets or sets the footer dialog of the MPCCandidateDialog.
    /// </summary>
    /// <remarks>
    ///     This property represents the footer dialog of the MPCCandidateDialog, which contains the Save and Cancel buttons.
    ...
    /// </remarks>
    [Parameter]
    public List<CandidateMPC> MPCGrid
    {
        get;
        set;
    }
    ...
    private async Task CancelMPCDialog(MouseEventArgs args) => await General.CallCancelMethod(args, Spinner, FooterDialog, Dialog, Cancel);
    ...
    /// </remarks>
    private void OpenDialog(BeforeOpenEventArgs arg) => EditMPCForm.EditContext?.Validate();
    ...
    /// </remarks>
    private async Task SaveMPCDialog(EditContext editContext) => await General.CallSaveMethod(editContext, Spinner, FooterDialog, Dialog, Save);
