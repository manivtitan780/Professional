...
public partial class EditExperienceDialog
{
	...
	private async Task CancelExperienceDialog(MouseEventArgs args) => await General.CallCancelMethod(args, Spinner, FooterDialog, Dialog, Cancel);
	...
	/// </remarks>
	private void OpenDialog() => EditExperienceForm.EditContext?.Validate();
	...
	/// </remarks>
	private async Task SaveExperienceDialog(EditContext editContext) => await General.CallSaveMethod(editContext, Spinner, FooterDialog, Dialog, Save);
