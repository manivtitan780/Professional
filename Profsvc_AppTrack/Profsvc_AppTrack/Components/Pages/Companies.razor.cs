...
public partial class Companies
{
	...
	/// </summary>
	private BasicInfoCompanyPanel ContactPanel
	{
		get;
		set;
	}
	...
	/// </remarks>
	[Inject]
	private ILogger<Companies> Logger
	{
		get;
		set;
	}
		...
		return ExecuteMethod(() =>
							 {
								 ...
								 return DialogDocument.Dialog.ShowAsync();
							 });
	}
	...
	/// <returns>A Task representing the asynchronous operation.</returns>
	private Task DeleteContact(int id)
	{
		return ExecuteMethod(async () =>
							 {
								 try
									 ...
									 Dictionary<string, string> _parameters = new()
																			  {
																				  ...
																				  {"companyName", _target.CompanyName},
																				  {"user", User}
																			  };
									 Dictionary<string, object> _response = await General.PostRest("Company/DeleteContact", _parameters);
									 if (_response == null)
									 {
										 return;
									 }
		...
		return ExecuteMethod(async () =>
							 {
								 try
								 {
									 ...
									 Dictionary<string, object> _response = await General.PostRest("Company/DeleteCompanyDocument", _parameters);
									 if (_response == null)
									 {
										 return;
									 }
		...
		return ExecuteMethod(async () =>
							 {
								 ...
								 Dictionary<string, object> _restResponse = await General.GetRest<Dictionary<string, object>>("Company/GetCompanyDetails", _parameters);
	...
	/// <returns>A Task that represents the asynchronous operation.</returns>
	private Task EditCompany(int id)
	{
		return ExecuteMethod(async () =>
							 {
								 if (id == 0)
