...
// Last Updated On:     12-23-2023 16:0
// *****************************************/
...
public partial class DocumentTypeDialog
{
    ...
    public async Task CancelDocType(MouseEventArgs args) => await General.CallCancelMethod(args, Spinner, DialogFooter, Dialog, Cancel);
    ...
    private async Task NoSpecialCharacters(object args) => await JsRuntime.InvokeVoidAsync("onCreateNoSpecial", "textText");
    ...
    /// <returns>A task that represents the asynchronous operation.</returns>
    private void OpenDialog(BeforeOpenEventArgs arg) => EditDocType.EditContext?.Validate();
    ...
    ///     operation.
    /// </remarks>
    internal async Task SaveDocType(EditContext editContext) => await General.CallSaveMethod(editContext, Spinner, DialogFooter, Dialog, Save);
