...
// Last Updated On:     09-03-2023 15:24
// *****************************************/
...
public partial class StateDialog
{
	...
	/// </remarks>
	private async Task CancelState(MouseEventArgs args) => await General.CallCancelMethod(args, Spinner, DialogFooter, Dialog, Cancel);
	...
	/// </remarks>
	private async Task SaveState(EditContext editContext) => await General.CallSaveMethod(editContext, Spinner, DialogFooter, Dialog, Save);
