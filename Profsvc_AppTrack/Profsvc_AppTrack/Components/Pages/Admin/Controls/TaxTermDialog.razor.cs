...
public partial class TaxTermDialog
{
    ...
    private Task CancelTaxTerm(MouseEventArgs args) => General.CallCancelMethod(args, Spinner, DialogFooter, Dialog, Cancel);
    ...
    /// </remarks>
    private Task SaveTaxTerm(EditContext editContext) => General.CallSaveMethod(editContext, Spinner, DialogFooter, Dialog, Save);
