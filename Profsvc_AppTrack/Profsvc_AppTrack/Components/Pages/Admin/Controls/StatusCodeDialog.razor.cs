...
// Last Updated On:     09-02-2023 20:07
// *****************************************/
...
public partial class StatusCodeDialog
{
	...
	private async Task CancelStatusCode(MouseEventArgs args) => await General.CallCancelMethod(args, Spinner, DialogFooter, Dialog, Cancel);
	...
	/// </remarks>
	private async Task SaveStatusCode(EditContext editContext) => await General.CallSaveMethod(editContext, Spinner, DialogFooter, Dialog, Save);
