...
public partial class Requisition
{
    ...
    //private bool _clickInProgress, _deleteInProgress, _detailGridPopulating, _downloadInProgress, _editInProgress, _filterInProgress, _speedDialItemClicked;
    ...
    /// </summary>
    internal SortDirection SortDirectionProperty
    {
        get;
        set;
    }
    ...
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    private async Task AdvancedSearch(MouseEventArgs args)
    {
        await Task.Yield();
    ...
    private void AllAlphabet(MouseEventArgs args)
    {
        if (_actionProgress)
        {
            return;
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        string _cookyString = await SessionStorage.GetItemAsync<string>("RequisitionGrid");
